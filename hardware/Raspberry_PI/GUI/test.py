...
class Start(QWidget):                                            #Klasse für das Dashboard    Das Dashboad soll den User über die Lage der Maschineberichten und dem User erlauben auf die Maschine einfluss zu haben.
    def __init__(self, parent=None):
        ...
        dashboard_button.clicked.connect(self.dashboard_clicked)
        self.start_layout.addWidget(dashboard_button)

    def dashboard_clicked(self):
        self.dashboard_succes.emit()
...
class MainWindow(QMainWindow):
    def __init__(self, firebase):
        ...
        self.start_screen.dashboard_succes.connect(self.show_dashboard_screen)
